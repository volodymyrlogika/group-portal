...
module.exports = require('./lib/color.js')
    .use(require('./lib/XYZ.js'))
    .use(require('./lib/LAB.js'))
    .use(require('./lib/HSV.js'))
    .use(require('./lib/HSL.js'))
    .use(require('./lib/CMYK.js'))

    // Convenience functions
    .use(require('./lib/plugins/namedColors.js'))
...
module.exports = function contrast(color) {
  ...
  color.use(require('./luminance.js'));
